...
_G.PointerColor = Color3.fromRGB(0, 255, 255)
...
if villageplace or game.PlaceId == trainingplace or game.PlaceId == rainplace or game.PlaceId == akatsukiplace or game.PlaceId == forestplace then
	...
	local jinfarm
	b:Toggle("JinFarm",function(bool)
		jinfarm = bool
	end)
...
if villageplace or game.PlaceId == trainingplace or game.PlaceId == rainplace or game.PlaceId == akatsukiplace or game.PlaceId == forestplace then
    ...
    g:Button("GodMode",function()
        loadstring(game:HttpGet('https://pastebin.com/raw/1RfEtjiP'))()
    end)
    g:Button("Disable",function()
...
if game.PlaceId == menuplace then
	...
	e:Label("Select the KG slot you want to change",{
		...
		BgColor = Color3.fromRGB(0, 255, 255);
	}) 
