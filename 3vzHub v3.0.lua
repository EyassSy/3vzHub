...
GameDetector.Parent = game.Workspace
...
Detecting.Position = UDim2.new(0.384889513, 0, 0.445945948, 0)
...
local function YAXAU_fake_script() -- Detecting.LocalScript 
...
coroutine.wrap(YAXAU_fake_script)()
